...
export const handleContentClassName = (s: StyleModule, open: boolean, isLarge?: boolean): string => {
  return isLarge ? `${s.accordion__content_text} ${s.accordion__content_text_small}` : `${s.accordion__content_text}`;
};
